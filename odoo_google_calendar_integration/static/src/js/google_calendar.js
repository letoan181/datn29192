odoo.define('odoo_google_calendar_integration.google_calendar_button', function (require) {
    "use strict";
    ...
    FormRenderer.include({
        events: _.extend({}, FormRenderer.prototype.events, {
            'click .o_my_google_sync_button': '_onMySyncCalendar',
        }),
        _onMySyncCalendar: function () {
            var self = this;
