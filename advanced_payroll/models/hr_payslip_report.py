...
class PayrollReportView(models.Model):
    ...
    def _select(self):
        ...
        """
        # select_str = """
        # min(ps.id) as id,emp.id as name,ps.date_from, ps.date_to, sum(psl.total) as net, ps.state as state
        # """
        return select_str
    ...
    def _group_by(self):
        ...
        """
        # group_by_str = """
        # group by emp.id,psl.total,ps.date_from, ps.date_to, ps.state
        # """
        return group_by_str
